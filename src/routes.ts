...
export function RegisterRoutes(app: express.Router) {
    ...
    app.post(
        ...
        function ExamController_postExam(
            request: any,
            response: any,
            next: any
        ) {
            ...
            try {
                ...
                const promise = controller.postExam.apply(
                    controller,
                    validatedArgs as any
                );
                promiseHandler(controller, promise, response, undefined, next);
    ...
    app.delete(
        ...
        ...fetchMiddlewares<RequestHandler>(ExamController),
        ...fetchMiddlewares<RequestHandler>(
            ExamController.prototype.deleteExam
        ),

        function ExamController_deleteExam(
            request: any,
            response: any,
            next: any
        ) {
            ...
            try {
                ...
                const promise = controller.deleteExam.apply(
                    controller,
                    validatedArgs as any
                );
                promiseHandler(controller, promise, response, undefined, next);
    ...
    app.delete(
        ...
        ...fetchMiddlewares<RequestHandler>(QuestionController),
        ...fetchMiddlewares<RequestHandler>(
            QuestionController.prototype.deleteQuestion
        ),

        function QuestionController_deleteQuestion(
            request: any,
            response: any,
            next: any
        ) {
            ...
            try {
                ...
                const promise = controller.deleteQuestion.apply(
                    controller,
                    validatedArgs as any
                );
                promiseHandler(controller, promise, response, undefined, next);
